...
export const projects: Project[] = [
  ...
  },
  {
    ...
    featured: true,
    images: [
      "/projects/gameboxd/screenshot1.png",
      "/projects/gameboxd/screenshot2.png",
      "/projects/gameboxd/screenshot3.png",
      "/projects/gameboxd/screenshot4.png",
      "/projects/gameboxd/screenshot5.png",
      "/projects/gameboxd/screenshot6.png",
      "/projects/gameboxd/screenshot7.png",
      "/projects/gameboxd/screenshot8.png",
      "/projects/gameboxd/screenshot9.png",
      "/projects/gameboxd/screenshot10.png",
      "/projects/gameboxd/screenshot11.png",
      "/projects/gameboxd/screenshot12.png",
      "/projects/gameboxd/screenshot13.png",
      "/projects/gameboxd/screenshot14.png",
      "/projects/gameboxd/screenshot15.png",
    ],
  ...
  },
  {
    ...
    featured: true,
    images: [
      "/projects/vizion/Screenshot 2026-04-13 155409.png",
      "/projects/vizion/Screenshot 2026-04-13 155459.png",
      "/projects/vizion/Screenshot 2026-04-13 155510.png",
      "/projects/vizion/Screenshot 2026-04-13 155556.png",
      "/projects/vizion/Screenshot 2026-04-13 155606.png",
      "/projects/vizion/Screenshot 2026-04-13 155619.png",
      "/projects/vizion/Screenshot 2026-04-13 155631.png",
      "/projects/vizion/Screenshot 2026-04-13 155659.png",
    ],
  ...
  },
  {
    id: 8,
    title: "EduVantage",
    description: "Native iOS learning platform for university students — course catalog, video lessons, assignments, study tools, and learning analytics.",
    longDescription: "University students need a centralized platform to manage their courses, track assignments, study with flashcards and timers, and monitor their learning progress. The challenge was building a polished, feature-rich native iOS app with offline data persistence and a smooth user experience.",
    category: "Mobile (iOS)",
    techStack: ["Swift", "SwiftUI", "CoreData", "Xcode", "iOS SDK"],
    githubUrl: "https://github.com/ttphan23/COMP3097_Project",
    liveUrl: "",
    featured: true,
    images: [
      "/projects/eduvantage/photo_2026-04-17_03-40-51.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-41-54.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-41-58.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-06.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-09.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-13.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-16.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-19.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-22.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-27.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-30.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-34.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-37.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-41.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-43.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-47.jpg",
      "/projects/eduvantage/photo_2026-04-17_03-42-50.jpg",
    ],
    course: "Mobile App Development (iOS)",
    semester: "Winter 2026",
    approach: "Designed the app with a tab-based navigation architecture (Home, Courses, Plan, Saved, Profile). Built the data layer with CoreData for offline-first persistence. Focused on creating a polished, production-quality UI with SwiftUI, including onboarding flows, email verification, and student identity verification.",
    technicalDecisions: "Chose SwiftUI over UIKit for declarative UI development and faster iteration. Used CoreData for local persistence since the app needed to work offline without a backend server. Implemented a modular architecture separating views, models, and data access layers. Built custom components for the video player, Pomodoro timer, and activity heat map.",
    keyLearnings: [
      "SwiftUI's declarative approach speeds up UI development significantly but requires a different mental model than imperative UIKit",
      "CoreData relationships and fetch requests require careful planning — especially for features like course enrollment, assignment tracking, and learning analytics",
      "Building a polished iOS app with onboarding, verification, and settings requires attention to platform conventions and Apple's Human Interface Guidelines",
    ],
  },
];
