            ...
            <div className="content-backdrop">
              ...
              <section style={{ marginBottom: '32px' }}>
                ...
                >
                  ...
                  <p style={{ fontSize: '13px', fontWeight: 600, color: 'var(--text-secondary)', margin: '0 0 12px' }}>
              ...
              <section style={{ marginBottom: '32px' }}>
                ...
                >
                  ...
                  <p style={{ fontSize: '12px', fontWeight: 500, color: 'var(--text-secondary)', margin: 0, lineHeight: '1.6' }}>
